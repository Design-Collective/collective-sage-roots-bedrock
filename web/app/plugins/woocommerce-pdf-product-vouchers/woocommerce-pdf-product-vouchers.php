...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '3.1.0', __( 'WooCommerce PDF Product Vouchers', 'woocommerce-pdf-product-vouchers' ), __FILE__, 'init_woocommerce_pdf_product_vouchers', array( 'minimum_wc_version' => '2.1', 'backwards_compatible' => '3.1.0' ) );
...
class WC_PDF_Product_Vouchers extends SV_WC_Plugin {
	...
	private function includes() {
		...
		require_once( "includes/class-wc-voucher.php" );

		require_once( "includes/class-wc-pdf-product-vouchers-product.php" );
		$this->product = new WC_PDF_Product_Vouchers_Product( $this );

		require_once( "includes/class-wc-pdf-product-vouchers-cart.php" );
		$this->cart = new WC_PDF_Product_Vouchers_Cart();

		require_once( "includes/class-wc-pdf-product-vouchers-my-account.php" );
		$this->my_account = new WC_PDF_Product_Vouchers_My_Account();

		require_once( "includes/class-wc-pdf-product-vouchers-taxonomy.php" );
		$this->taxonomy = new WC_PDF_Product_Vouchers_Taxonomy();

		require_once( "includes/class-wc-pdf-product-vouchers-voucher.php" );
		$this->voucher_handler = new WC_PDF_Product_Vouchers_Voucher( $this );

		require_once( "includes/class-wc-pdf-product-vouchers-order.php" );
	}
	...
	private function admin_includes() {
		...
		require_once( 'includes/admin/class-wc-pdf-product-vouchers-admin.php' );
	...
	public function include_template_functions() {
		require_once( 'includes/wc-pdf-product-vouchers-template.php' );
	}
	...
	public function add_email_classes( $email_classes ) {
		...
		require_once( "includes/emails/class-wc-pdf-product-vouchers-email-voucher-recipient.php" );
